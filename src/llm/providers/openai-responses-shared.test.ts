...
describe("convertResponsesMessages", () => {
  ...
  it("does not turn empty text-only tool outputs into fake image placeholders", () => {
    const input = convertResponsesMessages(
      nativeOpenAIModel,
      {
        systemPrompt: "system",
  ...
  it("does not use fake image placeholders for image-only outputs on text-only models", () => {
    const input = convertResponsesMessages(
      nativeOpenAIModel,
      {
        systemPrompt: "system",
